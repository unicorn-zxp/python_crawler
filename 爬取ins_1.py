...
class Ins_Spider:
    def __init__(self,user_name,save_path,save_number):
        ...
        self.uri = 'https://www.instagram.com/graphql/query/?query_hash=32b14723a678bd4628d70c1f877b94c9&variables=%7B%22id%22%3A%226831757312%22%2C%22first%22%3A12%2C%22after%22%3A%22{cursor}%3D%3D%22%7D'
        # 第一个转义的字符串
        self.cursor_list = []
    ...
    def parse_html_1(self):  
        ...
        self.cursor_list = re.findall(pattern1,html_1)
